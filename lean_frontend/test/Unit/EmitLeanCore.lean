...
"/-
  ...
  Kernel-transparent Lean terms for the T2–T6 slate programs: the
  parsed ASTs of the designated functions of
  tests/verify/{t2_add,t3_roundtrip,t4_struct_member,t5_sum,
  t6_branch}.core (the pinned oracle Core dumps of the .c fixtures;
  t6_branch is the arc-17 S1 acceptance-probe fixture), plus the
