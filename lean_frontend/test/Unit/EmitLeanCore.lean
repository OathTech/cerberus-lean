...
"/-
  ...
  Kernel-transparent Lean terms for the T2–T7 slate programs: the
  parsed ASTs of the designated functions of
  tests/verify/{t2_add,t3_roundtrip,t4_struct_member,t5_sum,
  t6_branch,t7_flip}.core (the pinned oracle Core dumps of the .c
  fixtures; t6_branch is the arc-17 S1 acceptance-probe fixture,
  t7_flip the arc-18 R2 branch-in-loop fixture), plus the
