...
def symRet498 : sym := Symbol "" 9907641387098162999 (SD_Id "ret_498")
...
def arena00 : RExpr :=
  (Expr aU (Esseq (Pattern aU (CaseBase (some symX, (BTy_object OTy_pointer)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Create (Pexpr aU () (PEctor Civalignof [(Pexpr aU () (PEval (Vctype intCty)))])) (Pexpr aU () (PEval (Vctype intCty))) (PrefOther "Core")))))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA499, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA500, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symV)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA500)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Store0 false (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symX)) (Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA499))])) NA))))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA501, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symX)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA501)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))))))

/-- Arena at state 1 (probe-transcribed verbatim). -/
def arena01 : RExpr :=
  (Expr aU (Esseq (Pattern aU (CaseBase (some symX, (BTy_object OTy_pointer)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Create (Pexpr [] () (PEval (Vobject (OVinteger (.IV .Prov_none 4))))) (Pexpr [] () (PEval (Vctype intCty))) (PrefOther "Core")))))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA499, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA500, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symV)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA500)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Store0 false (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symX)) (Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA499))])) NA))))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA501, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symX)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA501)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))))))

/-- Arena at state 2 (probe-transcribed verbatim). -/
def arena02 : RExpr :=
  (Expr aU (Esseq (Pattern aU (CaseBase (some symX, (BTy_object OTy_pointer)))) (Expr [] (Epure (Pexpr [] () (PEval xPtrV)))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA499, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA500, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symV)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA500)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Store0 false (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symX)) (Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA499))])) NA))))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA501, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symX)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA501)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))))))

/-- Arena at state 3 (probe-transcribed verbatim). -/
def arena03 : RExpr :=
  (Expr aU (Esseq (Pattern aU (CaseBase (some symA499, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA500, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symV)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA500)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Store0 false (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symX)) (Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA499))])) NA))))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA501, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symX)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA501)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))))

/-- Arena at state 4 (probe-transcribed verbatim). -/
def arena04 : RExpr :=
  (Expr aU (Esseq (Pattern aU (CaseBase (some symA499, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA500, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr [] () (PEval vPtrV)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA500)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Store0 false (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symX)) (Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA499))])) NA))))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA501, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symX)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA501)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))))
...
def arena08 (x : Int): RExpr :=
  (Expr aU (Esseq (Pattern aU (CaseBase (some symA499, (BTy_loaded OTy_integer)))) (Expr [] (Epure (Pexpr [] () (PEval (loadedV x))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Store0 false (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symX)) (Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA499))])) NA))))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA501, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symX)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA501)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))))
...
def arena10 (x : Int): RExpr :=
  (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Store0 false (Pexpr [] () (PEval (Vctype intCty))) (Pexpr [] () (PEval xPtrV)) (Pexpr [] () (PEval (loadedV x))) NA))))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA501, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symX)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA501)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))

/-- Arena at state 11 (probe-transcribed verbatim). -/
def arena11 : RExpr :=
  (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr [] (Eannot [(DA_pos [] (CerbMem.Footprint.FP .W 281474976710640 4))] (Expr [] (Epure (Pexpr [] () (PEval Vunit)))))) (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA501, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symX)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA501)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))

/-- Arena at state 12 (probe-transcribed verbatim). -/
def arena12 : RExpr :=
  (Expr [] (Eannot [(DA_pos [] (CerbMem.Footprint.FP .W 281474976710640 4))] (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA501, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr aU () (PEsym symX)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA501)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))

/-- Arena at state 13 (probe-transcribed verbatim). -/
def arena13 : RExpr :=
  (Expr [] (Eannot [(DA_pos [] (CerbMem.Footprint.FP .W 281474976710640 4))] (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr aU (Ebound (Expr aU (Ewseq (Pattern aU (CaseBase (some symA501, (BTy_object OTy_pointer)))) (Expr aU (Epure (Pexpr [] () (PEval xPtrV)))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Load0 (Pexpr aU () (PEval (Vctype intCty))) (Pexpr aU () (PEsym symA501)) NA))))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))
...
def arena17 (x : Int): RExpr :=
  (Expr [] (Eannot [(DA_pos [] (CerbMem.Footprint.FP .W 281474976710640 4))] (Expr aU (Esseq (Pattern aU (CaseBase (some symA502, (BTy_loaded OTy_integer)))) (Expr [] (Epure (Pexpr [] () (PEval (loadedV x))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))))
...
def arena19 : RExpr :=
  (Expr [] (Eannot [(DA_pos [] (CerbMem.Footprint.FP .W 281474976710640 4))] (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr [] () (PEval xPtrV))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))

/-- Arena at state 20 (probe-transcribed verbatim). -/
def arena20 : RExpr :=
  (Expr [] (Eannot [(DA_pos [] (CerbMem.Footprint.FP .W 281474976710640 4))] (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr [] (Epure (Pexpr [] () (PEval Vunit)))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))))

/-- Arena at state 21 (probe-transcribed verbatim). -/
def arena21 : RExpr :=
  (Expr [] (Eannot [(DA_pos [] (CerbMem.Footprint.FP .W 281474976710640 4))] (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Erun empty_annotation symRet498 [(Pexpr aU () (PEcall (Sym convLoadedIntSym) [(Pexpr aU () (PEval (Vctype intCty))), (Pexpr aU () (PEsym symA502))]))])) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Eaction (Paction Pos (Action CerbLocation.Loc.unknown empty_annotation (Kill (Static0 intCty) (Pexpr aU () (PEsym symX))))))) (Expr aU (Esseq (Pattern [] (CaseBase (none, BTy_unit))) (Expr aU (Epure (Pexpr aU () (PEval Vunit)))) (Expr aU (Esave (symRet498, (BTy_loaded OTy_integer)) [(symA503, (((BTy_loaded OTy_integer), none), (Pexpr aU () (PEundef CerbLocation.Loc.unknown (DUMMY "UB088_reached_end_of_function")))))] (Expr aU (Epure (Pexpr aU () (PEsym symA503))))))))))))))

/-- Arena at state 22 (probe-transcribed verbatim). -/
def arena22 : RExpr :=
  (Expr aU (Epure (Pexpr aU () (PEsym symA503))))
...
def patA500 : generic_pattern sym :=
  Pattern aU (CaseBase (some symA500, BTy_object OTy_pointer))
def patA499 : generic_pattern sym :=
  Pattern aU (CaseBase (some symA499, BTy_loaded OTy_integer))
def patA501 : generic_pattern sym :=
  Pattern aU (CaseBase (some symA501, BTy_object OTy_pointer))
def patA502 : generic_pattern sym :=
  Pattern aU (CaseBase (some symA502, BTy_loaded OTy_integer))
...
def env22 (x : Int) : List (Fmap sym value) :=
  update_env (mk_sym_pat symA503 (BTy_loaded OTy_integer))
    (loadedV x) (env18 x)
...
def convStorePE : generic_pexpr Unit sym :=
  Pexpr aU () (PEcall (Sym convLoadedIntSym)
    [Pexpr aU () (PEval (Vctype intCty)), Pexpr aU () (PEsym symA499)])
