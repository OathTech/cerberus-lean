...
-- same-commit provenance.)
/-- info: step_law census: 501 laws [advance 5, construct 12, envAlg 3, envMap 7, evalArith 2, evalPull 9, famInv 8, heapWP 4, loop 1, memBlock 7, memRW 21, perform 6, roundEq 356, roundGlue 3, segBlock 18, segLink 15, stateWP 24] -/
...
/--
info: RelSem audit sweep: 5304 declarations (module-of-origin root RelSem, within RelSem.Audit's import closure — NOT the whole tree), all within the declared axiom boundary (0 recorded sorryAx exceptions)
-/
#guard_msgs in
#eval show CoreM Unit from do
  let env ← getEnv
