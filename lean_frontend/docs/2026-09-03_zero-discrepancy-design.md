...
| Z-69 | `Main.lean` driver glue vs `backend/driver/main.ml` + `pipeline.ml` | Z-24 (flag handling), Z-28 (link order), Z-04 (error text), `--args` mirrored with cites | SEAM INDEX → Z-24 refusal landed (Z1 `b42776130`); Z-28 → Z3 | Z1 (done) / Z3 |
