...
| Z2-C-01 (= Z-60), Z2-C-02 | audit §2.4; `call/bool_param.c`, `call/errno_order.c` vs the rendered wrapper TUs | `Specified(1)`; `Specified(65524)` | UB012 trap (raw store of 2 into a `_Bool`); `Specified(65528)` (errno after the arguments) | **FIXED — Z2 `3744e8503`** (`CerbCall.mkCallSite` renders translation.lem:940-975/:1082-1112; `allocErrno` first; `tests/verify` rows) — was BUG-FIX (harness fidelity) | done |
| Z2-M-03/M-04/M-05/M-07/M-08/M-09/M-10/M-12/M-16, Z2-CP-03/04/07/08/09/11/13/16/18, Z2-P-04/P-05, Z2-L-02, Z2-DC-01, Z2-F-03, Z2-Q-01 | audit §2 (CP-13: the anonymous-tag `a_N`/`__cerbty_unnamed_tag_N` symbol mirror, reached by `test_core.sh tests/ci` — record §2.7/§8.4) | (each row's oracle behaviour, cited in code) | (each row's Lean-before, cited in code) | **MIRRORED — Z2 `3744e8503`/`5ed6c4a0a`** (docs/2026-09-04_zero-discrepancy-Z2-record.md §2.6–§2.8; the Z2-P-05 mirror moved the uri lane's pinned `LEAN_NOLIBC` error text to the oracle's wording) | done |
