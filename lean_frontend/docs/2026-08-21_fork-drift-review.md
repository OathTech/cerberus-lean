> RESTORED 2026-09-02 [AGENT; ruling USER 2026-09-02, release-hygiene item 1]: VERBATIM from tag `park/reasoning-era-20260831` (`lean_frontend/docs/reasoning-era/2026-08-21_fork-drift-review.md`), because live gates cite it — `scripts/check_fork_drift.sh` (+ `scripts/fork_drift_manifest.txt`, `scripts/test_unit.sh`) cite §6 as the gate spec.
