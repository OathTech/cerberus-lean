> RESTORED 2026-09-02 [AGENT; ruling USER 2026-09-02, release-hygiene item 1]: VERBATIM from tag `park/reasoning-era-20260831` (`lean_frontend/docs/reasoning-era/2026-08-21_upstream-oracle-build.md`), because live gates cite it — `tests/csmith_findings/README.md` cites its F-D three-way confirmation + caveats.
