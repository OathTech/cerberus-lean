> RESTORED 2026-09-02 [AGENT; ruling USER 2026-09-02, release-hygiene item 1]: VERBATIM from tag `park/reasoning-era-20260831` (`lean_frontend/docs/reasoning-era/2026-08-20_prototype-test-migration-survey.md`), because live gates cite it — `scripts/exec_float_baseline.txt` (§4.1) and `scripts/test_ci_sweep.sh` (§3.4/§6 item 4) cite it as the survey basis.
