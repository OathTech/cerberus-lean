...
cite-less register row); `--selftest` plants five doctored tables, three
doctored registers and three compiled decoy obligations (the third under a
contradictory hypothesis: MEASURED by shape, RED by the register). The ambient
