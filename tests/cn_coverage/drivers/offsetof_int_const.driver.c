/* cn_coverage ELAB driver: deps/cn/tests/cn/offsetof_int_const.c
 ...
 * Reason for trivial main: type-only file (typedef + _Static_assert, no C functions). The corpus TU is still fully
