/* cn_coverage ELAB driver: deps/cn/tests/cn/duplicate_datatype_var.error.c
 ...
 * Reason for trivial main: CN-spec-only file (no C declarations). The corpus TU is still fully
