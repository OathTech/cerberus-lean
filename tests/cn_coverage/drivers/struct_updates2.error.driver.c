/* cn_coverage ELAB driver: deps/cn/tests/cn/struct_updates2.error.c
 ...
 * Reason for trivial main: type-only file (struct definition + CN spec, no C functions). The corpus TU is still fully
