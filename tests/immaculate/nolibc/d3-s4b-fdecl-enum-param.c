...
// Desugar-time enum read S-4b: a function declared twice with an enum-typed
// parameter — cabs_to_ail_effect.lem register_function_declaration ->
// Cabs_to_ail_aux.make_composite_fdecl -> AilTypesAux.make_composite_params ->
// are_compatible -> normalise_integerType; seeded by `make_composite_fdecl_seeded`.
