/* SpecLab tree-rotation harness (tree BUILD-ONLY: builder-walker round trip).
...
int main(void)
{
  ...
  unsigned char expected[] = { 1, 1, 2, 3, 4, 1, 5, 6, 7, 8, 1, 9, 10, 11, 12, 0, 1, 13, 14, 15, 16, 0, 0, 1, 17, 18, 19, 20, 0, 0, 1, 21, 22, 23, 24, 0, 0, 1, 0 };
  struct node *root;
  struct node **link;
  struct node *newsub;
