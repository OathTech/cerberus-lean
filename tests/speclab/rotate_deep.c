...
int main(void)
{
  unsigned char choices[] = { 1, 111, 0, 0, 0, 1, 222, 0, 0, 0, 1, 77, 1, 0, 0, 1, 188, 1, 0, 0, 0, 0, 0, 0, 0, 2, 0, 0 };
  unsigned char expected[] = { 1, 111, 0, 0, 0, 1, 222, 0, 0, 0, 1, 188, 1, 0, 0, 0, 1, 77, 1, 0, 0, 0, 0, 0, 0 };
  struct node *root;
  struct node **link;
  struct node *newsub;
