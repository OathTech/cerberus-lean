...
int main(void)
{
  unsigned char choices[] = { 1, 101, 102, 103, 104, 1, 105, 106, 107, 108, 1, 109, 110, 111, 112, 0, 1, 113, 114, 115, 116, 0, 0, 1, 117, 118, 119, 120, 0, 0, 1, 121, 122, 123, 124, 0, 0, 1, 0 };
  unsigned char expected[] = { 1, 101, 102, 103, 104, 1, 109, 110, 111, 112, 0, 1, 105, 106, 107, 108, 1, 113, 114, 115, 116, 0, 0, 1, 117, 118, 119, 120, 0, 0, 1, 121, 122, 123, 124, 0, 0 };
  struct node *root;
  struct node **link;
  struct node *newsub;
