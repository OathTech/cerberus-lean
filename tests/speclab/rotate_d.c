...
int main(void)
{
  unsigned char choices[] = { 1, 201, 202, 203, 204, 1, 205, 206, 207, 208, 1, 209, 210, 211, 212, 0, 1, 213, 214, 215, 216, 0, 0, 1, 217, 218, 219, 220, 0, 0, 1, 221, 222, 223, 224, 0, 0, 1, 0 };
  unsigned char expected[] = { 1, 201, 202, 203, 204, 1, 209, 210, 211, 212, 0, 1, 205, 206, 207, 208, 1, 213, 214, 215, 216, 0, 0, 1, 217, 218, 219, 220, 0, 0, 1, 221, 222, 223, 224, 0, 0 };
  struct node *root;
  struct node **link;
  struct node *newsub;
