...
int main(void)
{
  const unsigned char choices[] = { 2, 0, 201, 202, 203, 204, 205, 206, 207, 208, 1, 0, 209, 210, 211, 212 };
  const unsigned char expected[] = { 3, 0, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212 };
  struct int_list *xs;
  struct int_list *ys;
  struct int_list *r;
  struct int_list *p;
