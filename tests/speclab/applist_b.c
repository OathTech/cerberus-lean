/* SpecLab linked-list harness (IntList_append Form 1: list builder, mismatch-index).
...
int main(void)
{
  const unsigned char choices[] = { 2, 0, 101, 102, 103, 104, 105, 106, 107, 108, 1, 0, 109, 110, 111, 112 };
  const unsigned char expected[] = { 3, 0, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112 };
  struct int_list *xs;
  struct int_list *ys;
  struct int_list *r;
  struct int_list *p;
