...
int main(void)
{
  unsigned char choices[] = { 1, 10, 0, 0, 0, 1, 20, 0, 0, 0, 1, 30, 0, 0, 0, 0, 1, 40, 0, 0, 0, 0, 0, 1, 50, 0, 0, 0, 0, 0, 1, 60, 0, 0, 0, 0, 0, 0 };
  unsigned char expected[] = { 1, 20, 0, 0, 0, 1, 30, 0, 0, 0, 0, 1, 40, 0, 0, 0, 0, 0, 1, 10, 0, 0, 0, 1, 50, 0, 0, 0, 0, 0, 1, 60, 0, 0, 0, 0, 0 };
  struct node *root;
  struct node **link;
  struct node *newsub;
