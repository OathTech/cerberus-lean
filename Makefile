...
LEAN_HANDWRITTEN = CerberusImpl.lean CerbLocation.lean CerberusFresh.lean \
    ...
    CerbFS.lean CerbConcurrency.lean CerbCtypeInstances.lean CerbStepInstances.lean CerbFunMapInstances.lean CerbCabsInstances.lean CerbInhabitedInstances.lean \
